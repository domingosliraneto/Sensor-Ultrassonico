      ...
      00026B 90 09 4C         [24] 1232 	mov	dptr,#_setLCD4
      ...
      000312 12 08 7D         [24] 1472 	lcall	__divuint
      ...
      00032A 12 08 C3         [24] 1485 	lcall	__moduint
      ...
      00033B 12 08 7D         [24] 1494 	lcall	__divuint
      ...
      000353 12 08 C3         [24] 1507 	lcall	__moduint
      ...
      000368 12 08 7D         [24] 1519 	lcall	__divuint
      ...
      000380 12 08 C3         [24] 1532 	lcall	__moduint
      ...
      000391 12 08 7D         [24] 1541 	lcall	__divuint
      ...
      0003A9 12 08 C3         [24] 1554 	lcall	__moduint
      ...
      000539 90 09 50         [24] 2053 	mov	dptr,#_Tit1
      ...
      00055A 90 09 5D         [24] 2081 	mov	dptr,#_Tit2
      ...
      00074A C2 0E            [12] 2443 	clr	_sensor
                           000678  2444 	C$controleNivel.c$206$1$50 ==.
                                   2445 ;	controleNivel.c:206: tempC=25-(Echo/58);
      ...
      000758 12 08 7D         [24] 2450 	lcall	__divuint
      00075B AE 82            [24] 2451 	mov	r6,dpl
      00075D AF 83            [24] 2452 	mov	r7,dph
      00075F 74 19            [12] 2453 	mov	a,#0x19
      ...
      00076C                       2462 00294$:
      00076C 02 08 6C         [24] 2463 	ljmp	00151$
      00076F                       2464 00295$:
      ...
      00082D F5 6C            [12] 2571 	mov	(_main_ctrlAt_1_50 + 1),a
                           00075B  2572 	C$controleNivel.c$216$3$73 ==.
                                   2573 ;	controleNivel.c:216: if(ctrlAt>255) ctrlAt=220;
      ...
      000840 75 6B DC         [24] 2582 	mov	_main_ctrlAt_1_50,#0xdc
      000843 75 6C 00         [24] 2583 	mov	(_main_ctrlAt_1_50 + 1),#0x00
      000846                       2584 00146$:
                           000772  2585 	C$controleNivel.c$217$3$73 ==.
                                   2586 ;	controleNivel.c:217: if(ctrlAt<0) ctrlAt=60;
      000846 E5 6C            [12] 2587 	mov	a,(_main_ctrlAt_1_50 + 1)
      000848 30 E7 06         [24] 2588 	jnb	acc.7,00148$
      00084B 75 6B 3C         [24] 2589 	mov	_main_ctrlAt_1_50,#0x3c
      00084E 75 6C 00         [24] 2590 	mov	(_main_ctrlAt_1_50 + 1),#0x00
      000851                       2591 00148$:
                           00077D  2592 	C$controleNivel.c$218$1$50 ==.
                                   2593 ;	controleNivel.c:218: pwm=ctrlAt*199/255;
      000851 85 6B 08         [24] 2594 	mov	__mulint_PARM_2,_main_ctrlAt_1_50
      000854 85 6C 09         [24] 2595 	mov	(__mulint_PARM_2 + 1),(_main_ctrlAt_1_50 + 1)
      000857 90 00 C7         [24] 2596 	mov	dptr,#0x00c7
      00085A 12 08 A6         [24] 2597 	lcall	__mulint
      00085D 75 08 FF         [24] 2598 	mov	__divsint_PARM_2,#0xff
      000860 75 09 00         [24] 2599 	mov	(__divsint_PARM_2 + 1),#0x00
      000863 12 09 10         [24] 2600 	lcall	__divsint
      000866 AE 82            [24] 2601 	mov	r6,dpl
      000868 AF 83            [24] 2602 	mov	r7,dph
      00086A 8E 66            [24] 2603 	mov	_pwm,r6
                           000798  2604 	C$controleNivel.c$221$2$55 ==.
                                   2605 ;	controleNivel.c:221: while(!umSeg); umSeg=0; tempo++;
      00086C                       2606 00151$:
                                   2607 ;	assignBit
      00086C 10 00 02         [24] 2608 	jbc	_umSeg,00298$
      00086F 80 FB            [24] 2609 	sjmp	00151$
      000871                       2610 00298$:
      000871 05 71            [12] 2611 	inc	_main_tempo_1_50
      000873 E4               [12] 2612 	clr	a
      000874 B5 71 02         [24] 2613 	cjne	a,_main_tempo_1_50,00299$
      000877 05 72            [12] 2614 	inc	(_main_tempo_1_50 + 1)
      000879                       2615 00299$:
      000879 02 05 80         [24] 2616 	ljmp	00155$
                           0007A8  2617 	C$controleNivel.c$225$1$50 ==.
                           0007A8  2618 	XG$main$0$0 ==.
      00087C 22               [24] 2619 	ret
                                   2620 	.area CSEG    (CODE)
                                   2621 	.area CONST   (CODE)
                           000000  2622 G$setLCD4$0$0 == .
      00094C                       2623 _setLCD4:
      00094C 28                    2624 	.db #0x28	; 40
      00094D 06                    2625 	.db #0x06	; 6
      00094E 0E                    2626 	.db #0x0e	; 14
      00094F 01                    2627 	.db #0x01	; 1
                           000004  2628 G$Tit1$0$0 == .
      000950                       2629 _Tit1:
      000950 70 20 20 20 20 69 20  2630 	.ascii "p    i    d "
             20 20 20 64 20
      00095C 00                    2631 	.db 0x00
                           000011  2632 G$Tit2$0$0 == .
      00095D                       2633 _Tit2:
      00095D 53 65 74 70 20 20 20  2634 	.ascii "Setp    Dist"
             20 44 69 73 74
      000969 00                    2635 	.db 0x00
